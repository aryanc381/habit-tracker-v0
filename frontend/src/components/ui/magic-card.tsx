...
export function MagicCard(props: MagicCardProps) {
  ...
  return (
    ...
    >
      <div className="bg-background absolute inset-px z-20 [border-radius:inherit]" />

      {mode === "gradient" && (
        <motion.div
          suppressHydrationWarning
          className="pointer-events-none absolute inset-px z-30 [border-radius:inherit] opacity-0 transition-opacity duration-300 group-hover:opacity-100"
          style={{
            background: useMotionTemplate`
              radial-gradient(${gradientSize}px circle at ${mouseX}px ${mouseY}px,
                ${gradientColor},
